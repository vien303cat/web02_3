...
CREATE TABLE `date` (
  `date_seq` int(10) NOT NULL,
  `date_txt` int(10) NOT NULL,
...
INSERT INTO `date` (`date_seq`, `date_txt`, `date_day`) VALUES
(1, 150, '2018-09-23'),
(2, 7, '2018-09-02');
...
CREATE TABLE `good` (
  `good_seq` int(10) UNSIGNED NOT NULL,
  `good_newseq` int(10) NOT NULL,
  `good_acc` text COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `good` (`good_seq`, `good_newseq`, `good_acc`) VALUES
(4, 2, 'qqq'),
(5, 1, 'qqq'),
(6, 4, 'qqq');
...
CREATE TABLE `member` (
  ...
  `member_email` text COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `news` (
  `news_seq` int(10) UNSIGNED NOT NULL,
  `news_txt` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `news_con` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `news_display` int(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `news` (`news_seq`, `news_txt`, `news_con`, `news_display`) VALUES
...
CREATE TABLE `qa1` (
  `qa1_seq` int(10) UNSIGNED NOT NULL,
  `qa1_txt` text COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `qa1` (`qa1_seq`, `qa1_txt`) VALUES
...
CREATE TABLE `qa2` (
  `qa2_seq` int(10) UNSIGNED NOT NULL,
  `qa2_txt` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `qa2_q1` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `qa2` (`qa2_seq`, `qa2_txt`, `qa2_q1`) VALUES
(1, '1.健走或爬樓梯、慢跑等較不受時間、場地限制的運動。', 1),
(2, '2.仰臥起坐、抬腿及伏地挺身、伸展操、瑜珈等室內運動。', 1),
(3, '3.球類運動、游泳、跳舞、騎腳踏車等加強心肺功能的運動。', 1),
(4, '4.舉重鍛鍊、彈力帶、啞鈴等運用輔助器材鍛鍊肌耐力的運動。', 1),
(5, '1.增加罹患冠狀動脈心臟病及罹病死亡之風險。', 2),
(6, '2.對孩子的的健康會產生許多影響，例如容易咳嗽或打噴嚏、罹患氣喘或讓症狀更嚴重、會因刺激耳咽管，感染中耳炎、肺功能較差、容易罹患呼吸道疾病等。', 2),
(7, '3.孕婦吸入二手菸易造成流產、早產、胎盤早期剝離、子宮感染等疾病。', 2),
(8, '4.長期的暴露會造成更嚴重的胸腔問題和過敏症，還會增加心臟病和肺癌的罹患率。', 2),
(9, '5.以上皆是。', 2),
(10, '1', 3),
(11, '2', 3),
(12, '3', 3);
...
CREATE TABLE `qalog` (
  `qalog_seq` int(10) UNSIGNED NOT NULL,
  `qalog_acc` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `qalog_q1` int(10) NOT NULL,
  `qalog_q2` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `qalog` (`qalog_seq`, `qalog_acc`, `qalog_q1`, `qalog_q2`) VALUES
(1, 'qqq', 2, 6),
(2, 'qqq', 2, 9),
(3, 'qqq', 1, 2);
...
--
ALTER TABLE `date`
  ADD PRIMARY KEY (`date_seq`);

--
-- 資料表索引 `good`
--
ALTER TABLE `good`
  ADD PRIMARY KEY (`good_seq`);
...
--
ALTER TABLE `news`
  ADD PRIMARY KEY (`news_seq`);

--
-- 資料表索引 `qa1`
--
ALTER TABLE `qa1`
  ADD PRIMARY KEY (`qa1_seq`);

--
-- 資料表索引 `qa2`
--
ALTER TABLE `qa2`
  ADD PRIMARY KEY (`qa2_seq`);

--
-- 資料表索引 `qalog`
--
ALTER TABLE `qalog`
  ADD PRIMARY KEY (`qalog_seq`);
...
--
ALTER TABLE `date`
  MODIFY `date_seq` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- 使用資料表 AUTO_INCREMENT `good`
--
ALTER TABLE `good`
  MODIFY `good_seq` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `news`
  MODIFY `news_seq` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- 使用資料表 AUTO_INCREMENT `qa1`
--
ALTER TABLE `qa1`
  MODIFY `qa1_seq` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- 使用資料表 AUTO_INCREMENT `qa2`
--
ALTER TABLE `qa2`
  MODIFY `qa2_seq` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- 使用資料表 AUTO_INCREMENT `qalog`
--
ALTER TABLE `qalog`
  MODIFY `qalog_seq` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
COMMIT;
